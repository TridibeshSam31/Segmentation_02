...
def main():
    ...
    data_dir = os.path.join(script_dir, r'..', r'Offroad_Segmentation_Training_Dataset', r'train')
    val_dir = os.path.join(script_dir, r'..', r'Offroad_Segmentation_Training_Dataset', r'val')
